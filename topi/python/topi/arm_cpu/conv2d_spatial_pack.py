...
def conv2d_spatial_pack_nchw_dv(cfg, data, kernel, strides, padding, dilation,
                             out_dtype, num_tile):
    """compute define for Conv2d Spatial Pack with NCHW layout"""
    out_dtype = out_dtype or data.dtype
    N, CI, IH, IW = get_const_tuple(data.shape)
    ...
    cfg.define_reorder("reorder_0",
                       ...
                       policy='candidate', candidate=[
                           ...
                           #[n, co, oh, ow, kh, kw, ci, vh, vw, vc],
                           #[n, co, oh, ow, kh, kw, ci, vc, vh, vw],
                           #[n, co, oh, ow, kh, kw, vc, ci, vh, vw],
                           #[n, co, oh, ow, kh, kw, vh, vw, vc, ci],
                           #[co, oh, ow, n, ci, kh, kw, vh, vw, vc],
                           #[co, oh, ow, n, ci, kh, kw, vc, vh, vw],
                           #[co, oh, ow, n, ci, vh, vw, vc, kh, kw],
                           #[co, oh, ow, n, ci, vc, vh, vw, kh, kw],
                           #[co, oh, ow, n, kh, kw, ci, vh, vw, vc],
                           #[co, oh, ow, n, kh, kw, ci, vc, vh, vw],
                           #[co, oh, ow, n, kh, kw, vc, ci, vh, vw],
                           #[co, oh, ow, n, kh, kw, vh, vw, vc, ci],
                           #[co, oh, ow, ci, n, kh, kw, vh, vw, vc],
                           #[co, oh, ow, ci, n, kh, kw, vc, vh, vw],
                           #[co, oh, ow, ci, n, vh, vw, vc, kh, kw],
                           #[co, oh, ow, ci, n, vc, vh, vw, kh, kw],
                           #[co, oh, ow, kh, kw, n, ci, vh, vw, vc],
                           #[co, oh, ow, kh, kw, n, ci, vc, vh, vw],
                           #[co, oh, ow, kh, kw, n, vc, ci, vh, vw],
                           #[co, oh, ow, kh, kw, n, vh, vw, vc, ci],
                           #[co, oh, ow, ci, kh, kw, n, vh, vw, vc],
                           #[co, oh, ow, ci, kh, kw, n, vc, vh, vw],
                           #[co, oh, ow, ci, vh, vw, n, vc, kh, kw],
                           #[co, oh, ow, ci, vc, n, vh, vw, kh, kw],
                           #[co, oh, ow, kh, kw, ci, n, vh, vw, vc],
                           #[co, oh, ow, kh, kw, ci, n, vc, vh, vw],
                           #[co, oh, ow, kh, kw, vc, n, ci, vh, vw],
                           #[co, oh, ow, kh, kw, vh, vw, n, vc, ci],
                           #[co, oh, ow, ci, kh, kw, vh, vw, n, vc],
                           #[co, oh, ow, ci, kh, kw, vc, n, vh, vw],
                           #[co, oh, ow, ci, vh, vw, vc, n, kh, kw],
                           #[co, oh, ow, ci, vc, vh, vw, n, kh, kw],
                           #[co, oh, ow, kh, kw, ci, vh, vw, n, vc],
                           #[co, oh, ow, kh, kw, ci, vc, n, vh, vw],
                           #[co, oh, ow, kh, kw, vc, ci, n, vh, vw],
                           #[co, oh, ow, kh, kw, vh, vw, vc, n, ci],
                           #[co, oh, ow, ci, kh, kw, vh, vw, vc, n],
                           #[co, oh, ow, ci, kh, kw, vc, vh, vw, n],
                           #[co, oh, ow, ci, vh, vw, vc, kh, kw, n],
                           #[co, oh, ow, ci, vc, vh, vw, kh, kw, n],
                           #[co, oh, ow, kh, kw, ci, vh, vw, vc, n],
                           #[co, oh, ow, kh, kw, ci, vc, vh, vw, n],
                           #[co, oh, ow, kh, kw, vc, ci, vh, vw, n],
                           #[co, oh, ow, kh, kw, vh, vw, vc, ci, n]])
                           [n, co, oh, ow, ci, kh, kw, vc, vh, vw]])

    #cfg.define_annotate("ann_reduce", [kh, kw], policy='try_unroll')
    #cfg.define_annotate("ann_spatial", [vh, vw, vc], policy='try_vec')
...
def schedule_conv2d_spatial_pack_nchw_dv(cfg, s, data_vec, kernel_vec,
                                      conv, output, last):
    """schedule implementation"""
    n, co, oh, ow, vh, vw, vc = s[conv].op.axis
    ci, kh, kw = s[conv].op.reduce_axis

    # Save Extents, indices for calculating data volume to config
    order = [n, co, oh, ow, ci, kh, kw, vh, vw, vc]
    extents = []
    for ind in order:
        extents.append(ind.dom.extent.value)
    cfg.extents = extents
    array_dims = [ [], [], [] ]
    for ind in [n, oh, ow, ci, kh, kw, vh, vw]: #Input indices
        array_dims[0].append(order.index(ind))
    for ind in [co, ci, kh, kw, vc]: #Kernel indices
        array_dims[1].append(order.index(ind))
    for ind in [n, co, oh, ow, vh, vw, vc]: #Output indices
        array_dims[2].append(order.index(ind))
